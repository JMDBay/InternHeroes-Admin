...
class VercelUsersTable extends StatelessWidget {
  @override
          ...
          Positioned(
            ...
            child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                // Filter users with "Vercel" in their careerPath
                List<UserListItem> userList = snapshot.data!.docs
                    .map((doc) => UserListItem.fromDocumentSnapshot(doc))
                    .where((user) => user.careerPath.contains('Vercel'))
                    .toList();

                if (userList.isEmpty) {
                  return Center(
                    child: Text(
                        'No users found with "Vercel" in their careerPath.'),
                  );
                }
                      ...
                      child: Padding(
                        ...
                        child: DataTable(
                          ...
                          columns: [
                            ...
                            DataColumn(
                              label:
                                  Text('OJT Coordinator Email'.toUpperCase()),
                            ),
                            DataColumn(
