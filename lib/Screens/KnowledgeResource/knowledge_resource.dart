...
class _KnowledgeResourceState extends State<KnowledgeResourcePage> {
  ...
  void initState() {
    ...
    _postsQuery = FirebaseFirestore.instance
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        ...
        pageBuilder: (BuildContext context, _, __) =>
            _buildPostDetailsDialog(context, post),
      ),
    );
  }

  Widget _buildPostDetailsDialog(BuildContext context, DocumentSnapshot post) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: PostDetailsDialog(post: post), // Pass the 'post' argument
      ),
    );
  }
  ...
  void _addPost(BuildContext context) {
    Navigator.push(
      ...
      PageRouteBuilder(
        opaque: false,
        pageBuilder: (BuildContext context, _, __) =>
            _buildOverlayBackground(context),
      ),
    );
  }

  Widget _buildOverlayBackground(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.pop(context);
      },
      child: Container(
        color: Colors.black.withOpacity(0.5), // Adjust opacity for darkness
        child: ChooseTypePage(), // Your ChooseTypePage widget goes here
      ),
    );
  }
