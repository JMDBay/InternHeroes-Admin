...
class _AddPostCertPageState extends State<AddPostCerts> {
        ...
        body: SingleChildScrollView(
            ...
            child:
              ...
              _buildTextFieldWithTitle(
                  'Course Description:', _descriptionController),
              SizedBox(height: 10),
              _buildTextFieldWithTitle(
                  'Requirements:', _requirementsController),
              SizedBox(height: 10),
              _buildTextFieldWithTitle(
                  'What will you learn:', _learnController),
              SizedBox(height: 10),
              _buildTextFieldWithTitle(
                  'Course highlights:', _highlightsController),
              SizedBox(height: 10),
              _buildTextFieldWithTitle(
                  'Who this course is for:', _forController),
              SizedBox(height: 10),
              _buildTextFieldWithTitle(
                  'Prerequisites:', _prerequisitesController),
              SizedBox(height: 10),
  ...
  void _addLink() {
    showDialog(
      context: context,
      barrierDismissible:
          true, // Set to true to allow dismissing by tapping outside
