            ...
            children: [
              ...
              StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where('userId',
                        isEqualTo:
                            uid) // Fetch posts where userId matches viewed user's uid
                    .snapshots(),
                      ...
                      return GestureDetector(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                                height:
                                    1), // Add some space between "Posted by" and "Date Posted"
                            Padding(
                            ...
                            Center(
                              child: Divider(
                                ...
                                thickness: 1,
                                indent:
                                    20, // Adjusted the start position of the divider
                                endIndent:
                ...
                builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      var certificateData =
                          certificate.data() as Map<String, dynamic>;
                  ...
                  return SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        buildProfileItem(
                            'Phone Number', userData['phoneNumber'] as String?),
                        buildProfileItem(
                        ...
                        buildProfileItem(
                            'Career Path',
                            (userData['careerPath'] as List<dynamic>)
                                .join(', ')),
                        const SizedBox(height: 20),
                      ],
                    ),
